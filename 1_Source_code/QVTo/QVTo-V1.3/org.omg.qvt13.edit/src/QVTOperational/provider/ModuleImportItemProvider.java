...
/**
 * This is the item provider adapter for a {@link QVTOperational.ModuleImport} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleImportItemProvider extends ElementItemProvider {
	/**
	...
	protected void addIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModuleImport_identifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModuleImport_identifier_feature", "_UI_ModuleImport_type"),
				 QVTOperationalPackage.Literals.MODULE_IMPORT__IDENTIFIER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QVTOperationalPackage.Literals.MODULE_IMPORT__UNIT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QVTOperationalPackage.Literals.MODULE_IMPORT__UNIT,
				 QVTOperationalFactory.eINSTANCE.createUnitRefGO()));
	}
