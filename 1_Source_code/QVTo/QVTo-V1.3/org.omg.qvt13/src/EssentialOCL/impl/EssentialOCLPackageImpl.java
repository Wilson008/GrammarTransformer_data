...
import EssentialOCL.TemplateParameterType;
...
public class EssentialOCLPackageImpl extends EPackageImpl implements EssentialOCLPackage {
	...
	public static EssentialOCLPackage init() {
		...
		Object registeredEssentialOCLPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		EssentialOCLPackageImpl theEssentialOCLPackage = registeredEssentialOCLPackage instanceof EssentialOCLPackageImpl ? (EssentialOCLPackageImpl)registeredEssentialOCLPackage : new EssentialOCLPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEReference(getCollectionLiteralPart_CollectionLiteralExp(), this.getCollectionLiteralExp(), this.getCollectionLiteralExp_Part(), "collectionLiteralExp", null, 0, 1, CollectionLiteralPart.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
