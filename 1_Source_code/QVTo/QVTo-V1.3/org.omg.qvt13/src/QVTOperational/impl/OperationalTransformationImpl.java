...
public class OperationalTransformationImpl extends ModuleImpl implements OperationalTransformation {
	...
	public EList<ModelParameter> getModelParameter() {
		if (modelParameter == null) {
			modelParameter = new EObjectContainmentWithInverseEList<ModelParameter>(ModelParameter.class, this, QVTOperationalPackage.OPERATIONAL_TRANSFORMATION__MODEL_PARAMETER, QVTOperationalPackage.MODEL_PARAMETER__MODULE);
		}
