...
/**
 * This is the item provider adapter for a {@link qvtoperational.Declarator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeclaratorItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QvtoperationalPackage.Literals.DECLARATOR__TYPESPEC);
			childrenFeatures.add(QvtoperationalPackage.Literals.DECLARATOR__INIT_PART);
			childrenFeatures.add(QvtoperationalPackage.Literals.DECLARATOR__SCOPED_IDENTIFIER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QvtoperationalPackage.Literals.DECLARATOR__TYPESPEC,
				 QvtoperationalFactory.eINSTANCE.createTypeSpec()));

		newChildDescriptors.add
			(createChildParameter
				(QvtoperationalPackage.Literals.DECLARATOR__INIT_PART,
				 QvtoperationalFactory.eINSTANCE.createInitPart()));

		newChildDescriptors.add
			(createChildParameter
				(QvtoperationalPackage.Literals.DECLARATOR__SCOPED_IDENTIFIER,
