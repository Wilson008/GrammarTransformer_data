...
/**
 * This is the item provider adapter for a {@link qvtoperational.ClassifierGO} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassifierGOItemProvider extends ImperativeOperationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ClassifierGOItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QvtoperationalPackage.Literals.CLASSIFIER_GO__CLASSIFIER_H);
			childrenFeatures.add(QvtoperationalPackage.Literals.CLASSIFIER_GO__CLASSIFIER_FEATURE_LIST);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ClassifierGO"));
	}
	...
	public String getText(Object object) {
		String label = ((ClassifierGO)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ClassifierGO_type") :
			getString("_UI_ClassifierGO_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ClassifierGO.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QvtoperationalPackage.Literals.CLASSIFIER_GO__CLASSIFIER_H,
				 QvtoperationalFactory.eINSTANCE.createClassifierHeader()));

		newChildDescriptors.add
			(createChildParameter
				(QvtoperationalPackage.Literals.CLASSIFIER_GO__CLASSIFIER_FEATURE_LIST,
				 QvtoperationalFactory.eINSTANCE.createClassifierFeatureList()));
	}
