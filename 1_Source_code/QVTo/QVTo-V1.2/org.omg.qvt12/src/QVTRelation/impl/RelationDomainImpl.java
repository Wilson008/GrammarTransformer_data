...
public class RelationDomainImpl extends DomainImpl implements RelationDomain {
	...
	public void setPattern(DomainPattern newPattern) {
		if (newPattern != pattern) {
			...
			if (pattern != null)
				msgs = ((InternalEObject)pattern).eInverseRemove(this, QVTRelationPackage.DOMAIN_PATTERN__RELATION_DOMAIN, DomainPattern.class, msgs);
			if (newPattern != null)
				msgs = ((InternalEObject)newPattern).eInverseAdd(this, QVTRelationPackage.DOMAIN_PATTERN__RELATION_DOMAIN, DomainPattern.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case QVTRelationPackage.RELATION_DOMAIN__PATTERN:
				...
				return basicSetPattern((DomainPattern)otherEnd, msgs);
		}
