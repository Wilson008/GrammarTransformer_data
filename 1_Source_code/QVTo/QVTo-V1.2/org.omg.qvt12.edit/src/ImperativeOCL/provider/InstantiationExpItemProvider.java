...
public class InstantiationExpItemProvider extends ImperativeExpressionItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInitializationOperationPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Initialization Operation feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInitializationOperationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InstantiationExp_initializationOperation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InstantiationExp_initializationOperation_feature", "_UI_InstantiationExp_type"),
				 ImperativeOCLPackage.Literals.INSTANTIATION_EXP__INITIALIZATION_OPERATION,
				 true,
				 false,
				 true,
				 null,
