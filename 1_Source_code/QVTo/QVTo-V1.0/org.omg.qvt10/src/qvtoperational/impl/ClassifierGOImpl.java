...
public class ClassifierGOImpl extends ImperativeOperationImpl implements ClassifierGO {
	...
	public EList<emof.Package> getNestedPackage() {
		if (nestedPackage == null) {
			nestedPackage = new EObjectContainmentEList<emof.Package>(emof.Package.class, this, QvtoperationalPackage.CLASSIFIER_GO__NESTED_PACKAGE);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == qvtoperational.Module.class) {
			switch (derivedFeatureID) {
				...
				case QvtoperationalPackage.CLASSIFIER_GO__IS_BLACKBOX: return QvtoperationalPackage.MODULE__IS_BLACKBOX;
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == qvtoperational.Module.class) {
			switch (baseFeatureID) {
				...
				case QvtoperationalPackage.MODULE__IS_BLACKBOX: return QvtoperationalPackage.CLASSIFIER_GO__IS_BLACKBOX;
