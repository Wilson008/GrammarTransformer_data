...
public class VarParameterImpl extends ParameterImpl implements VarParameter {
	...
	/**
	 * The cached value of the '{@link #getCtxOwner() <em>Ctx Owner</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCtxOwner()
	 * @generated
	 * @ordered
	 */
	protected ImperativeOperation ctxOwner;
	...
	public ImperativeOperation getCtxOwner() {
		if (ctxOwner != null && ctxOwner.eIsProxy()) {
			InternalEObject oldCtxOwner = (InternalEObject)ctxOwner;
			ctxOwner = (ImperativeOperation)eResolveProxy(oldCtxOwner);
			if (ctxOwner != oldCtxOwner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QvtoperationalPackage.VAR_PARAMETER__CTX_OWNER, oldCtxOwner, ctxOwner));
			}
		}
		return ctxOwner;
	}
	 ...
	 * @generated
	 */
	public ImperativeOperation basicGetCtxOwner() {
		return ctxOwner;
	}
	...
	public void setCtxOwner(ImperativeOperation newCtxOwner) {
		ImperativeOperation oldCtxOwner = ctxOwner;
		ctxOwner = newCtxOwner;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QvtoperationalPackage.VAR_PARAMETER__CTX_OWNER, oldCtxOwner, ctxOwner));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case QvtoperationalPackage.VAR_PARAMETER__CTX_OWNER:
				if (resolve) return getCtxOwner();
				return basicGetCtxOwner();
			case QvtoperationalPackage.VAR_PARAMETER__RES_OWNER:
				return getResOwner();
