 ...
 *   <li>{@link qvtoperational.impl.EntryOperationImpl#getIsBlackbox <em>Is Blackbox</em>}</li>
...
public class EntryOperationImpl extends ImperativeOperationImpl implements EntryOperation {
	...
	public EList<emof.Package> getNestedPackage() {
		if (nestedPackage == null) {
			nestedPackage = new EObjectContainmentEList<emof.Package>(emof.Package.class, this, QvtoperationalPackage.ENTRY_OPERATION__NESTED_PACKAGE);
		}
	...
	public void setIsBlackbox(Boolean newIsBlackbox) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QvtoperationalPackage.ENTRY_OPERATION__IS_BLACKBOX, oldIsBlackbox, isBlackbox));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == qvtoperational.Module.class) {
			switch (derivedFeatureID) {
				...
				case QvtoperationalPackage.ENTRY_OPERATION__IS_BLACKBOX: return QvtoperationalPackage.MODULE__IS_BLACKBOX;
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == qvtoperational.Module.class) {
			switch (baseFeatureID) {
				...
				case QvtoperationalPackage.MODULE__IS_BLACKBOX: return QvtoperationalPackage.ENTRY_OPERATION__IS_BLACKBOX;
