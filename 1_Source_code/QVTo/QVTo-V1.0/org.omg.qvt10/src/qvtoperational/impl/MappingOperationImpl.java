 ...
 *   <li>{@link qvtoperational.impl.MappingOperationImpl#getIsBlackbox <em>Is Blackbox</em>}</li>
...
public class MappingOperationImpl extends ImperativeOperationImpl implements MappingOperation {
	 ...
	 * @ordered
	 */
	protected EList<ExpressionGO> when;
	 ...
	 * @ordered
	 */
	protected EList<ExpressionGO> where;
	...
	public EList<emof.Package> getNestedPackage() {
		if (nestedPackage == null) {
			nestedPackage = new EObjectContainmentEList<emof.Package>(emof.Package.class, this, QvtoperationalPackage.MAPPING_OPERATION__NESTED_PACKAGE);
		}
	...
	public void setIsBlackbox(Boolean newIsBlackbox) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QvtoperationalPackage.MAPPING_OPERATION__IS_BLACKBOX, oldIsBlackbox, isBlackbox));
	}
	 ...
	 * @generated
	 */
	public EList<ExpressionGO> getWhen() {
		if (when == null) {
			when = new EObjectContainmentEList<ExpressionGO>(ExpressionGO.class, this, QvtoperationalPackage.MAPPING_OPERATION__WHEN);
		}
		return when;
	}
	 ...
	 * @generated
	 */
	public EList<ExpressionGO> getWhere() {
		if (where == null) {
			where = new EObjectContainmentEList<ExpressionGO>(ExpressionGO.class, this, QvtoperationalPackage.MAPPING_OPERATION__WHERE);
		}
		return where;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case QvtoperationalPackage.MAPPING_OPERATION__IS_BLACKBOX:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case QvtoperationalPackage.MAPPING_OPERATION__WHEN:
				getWhen().clear();
				getWhen().addAll((Collection<? extends ExpressionGO>)newValue);
				return;
			case QvtoperationalPackage.MAPPING_OPERATION__WHERE:
				getWhere().clear();
				getWhere().addAll((Collection<? extends ExpressionGO>)newValue);
				return;
			case QvtoperationalPackage.MAPPING_OPERATION__MAPPING_FULL_HEADER:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == qvtoperational.Module.class) {
			switch (derivedFeatureID) {
				...
				case QvtoperationalPackage.MAPPING_OPERATION__IS_BLACKBOX: return QvtoperationalPackage.MODULE__IS_BLACKBOX;
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == qvtoperational.Module.class) {
			switch (baseFeatureID) {
				...
				case QvtoperationalPackage.MODULE__IS_BLACKBOX: return QvtoperationalPackage.MAPPING_OPERATION__IS_BLACKBOX;
