...
/**
 * This is the item provider adapter for a {@link qvtoperational.AccessDecl} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AccessDeclItemProvider extends ModuleItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AccessDeclItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QvtoperationalPackage.Literals.ACCESS_DECL__ACCESS_USAGE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AccessDecl"));
	}
	...
	public String getText(Object object) {
		String label = ((AccessDecl)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AccessDecl_type") :
			getString("_UI_AccessDecl_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AccessDecl.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QvtoperationalPackage.Literals.ACCESS_DECL__ACCESS_USAGE,
