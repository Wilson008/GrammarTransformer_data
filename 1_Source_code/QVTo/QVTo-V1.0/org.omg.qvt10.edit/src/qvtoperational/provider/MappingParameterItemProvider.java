...
public class MappingParameterItemProvider extends VarParameterItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addRefinedDomainPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Refined Domain feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRefinedDomainPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MappingParameter_refinedDomain_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MappingParameter_refinedDomain_feature", "_UI_MappingParameter_type"),
