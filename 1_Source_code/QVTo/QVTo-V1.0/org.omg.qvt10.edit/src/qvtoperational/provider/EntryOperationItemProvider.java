...
/**
 * This is the item provider adapter for a {@link qvtoperational.EntryOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntryOperationItemProvider extends ImperativeOperationItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QvtoperationalPackage.Literals.ENTRY_OPERATION__ENTRY_HEADER);
			childrenFeatures.add(QvtoperationalPackage.Literals.ENTRY_OPERATION__EXPRESSION_BLOCK);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EntryOperation.class)) {
			case QvtoperationalPackage.ENTRY_OPERATION__URI:
			case QvtoperationalPackage.ENTRY_OPERATION__IS_BLACKBOX:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QvtoperationalPackage.Literals.ENTRY_OPERATION__ENTRY_HEADER,
				 QvtoperationalFactory.eINSTANCE.createEntryHeader()));

		newChildDescriptors.add
			(createChildParameter
				(QvtoperationalPackage.Literals.ENTRY_OPERATION__EXPRESSION_BLOCK,
