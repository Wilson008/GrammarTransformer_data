 ...
 */
package org.omg.qvt10.myqvto.ide.contentassist.antlr;
...
import org.omg.qvt10.myqvto.ide.contentassist.antlr.internal.InternalMyQvtoParser;
...
public class MyQvtoParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyQvtoGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getModelTypeAccess().getGroup_7(), "rule__ModelType__Group_7__0");
			...
			builder.put(grammarAccess.getModelTypeAccess().getNameAssignment_2(), "rule__ModelType__NameAssignment_2");
			builder.put(grammarAccess.getModelTypeAccess().getCompliance_kindAssignment_3(), "rule__ModelType__Compliance_kindAssignment_3");
			builder.put(grammarAccess.getModelTypeAccess().getPackageref_listAssignment_5(), "rule__ModelType__Packageref_listAssignment_5");
			builder.put(grammarAccess.getModelTypeAccess().getPackageref_listAssignment_6_1(), "rule__ModelType__Packageref_listAssignment_6_1");
			builder.put(grammarAccess.getModelTypeAccess().getModeltype_whereAssignment_7_1(), "rule__ModelType__Modeltype_whereAssignment_7_1");
			...
			builder.put(grammarAccess.getTypeDefAccess().getTypedef_conditionAssignment_4_1(), "rule__TypeDef__Typedef_conditionAssignment_4_1");
