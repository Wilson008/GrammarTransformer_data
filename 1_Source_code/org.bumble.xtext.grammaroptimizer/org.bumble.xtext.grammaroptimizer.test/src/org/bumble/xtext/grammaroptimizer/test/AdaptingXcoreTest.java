...
public class AdaptingXcoreTest {
	...
	public void testAdaptingMyXcore() {
		...
		// Add text import "http://www.eclipse.org/xtext/xbase/Xbase" as xbase
		go.addImport("import \"http://www.eclipse.org/xtext/xbase/Xbase\" as xbase");
		
		// Add text import "http://www.eclipse.org/emf/2002/GenModel" as genmodel
		go.addImport("import \"http://www.eclipse.org/emf/2002/GenModel\" as genmodel");
		
		// Add text import "http://www.eclipse.org/xtext/common/JavaVMTypes" as javaVMTypes
		go.addImport("import \"http://www.eclipse.org/xtext/common/JavaVMTypes\" as javaVMTypes");
		
		// Add text import "http://www.eclipse.org/xtext/xbase/Xtype" as xtype
		go.addImport("import \"http://www.eclipse.org/xtext/xbase/Xtype\" as xtype");
...
//		go.renameKeyword("XClass", null, "XClass", "class", null);
		...
		go.renameRule("XDataType_Impl", "XDataType_Impl", "XDataType");
		...
		go.renameRule("EInt", "EInt", "SignedInt");
