...
public class OptimizeSMLTest {
	...
	public void testOptimizeSML() {
		...
		go.renameRule("ParameterExpression_Impl", "ParameterExpression_Impl", "ParameterExpression");
		...
		go.renameRule("Message_Impl", "Message_Impl", "ConstraintMessage");
		...
		go.addImport("import \"http://www.scenariotools.org/sml\"");
		go.addImport("import \"http://www.scenariotools.org/sml/expressions/ScenarioExpressions\"");
		go.addImport("import \"http://www.eclipse.org/emf/2002/Ecore\" as ecore");
