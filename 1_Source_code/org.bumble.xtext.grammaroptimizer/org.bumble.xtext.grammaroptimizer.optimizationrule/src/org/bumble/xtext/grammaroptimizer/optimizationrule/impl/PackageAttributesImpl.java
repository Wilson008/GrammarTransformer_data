 ...
 * </p>
 * <ul>
 *   <li>{@link org.bumble.xtext.grammaroptimizer.optimizationrule.impl.PackageAttributesImpl#getStartAttr <em>Start Attr</em>}</li>
 *   <li>{@link org.bumble.xtext.grammaroptimizer.optimizationrule.impl.PackageAttributesImpl#getEndAttr <em>End Attr</em>}</li>
 *   <li>{@link org.bumble.xtext.grammaroptimizer.optimizationrule.impl.PackageAttributesImpl#getPackagetype <em>Packagetype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackageAttributesImpl extends OptimizationRuleImpl implements PackageAttributes {
	/**
	...
	/**
	 * The default value of the '{@link #getPackagetype() <em>Packagetype</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPackagetype()
	 * @generated
	 * @ordered
	 */
	protected static final PackageKey PACKAGETYPE_EDEFAULT = PackageKey.PACKAGE_ONLY;

	/**
	 * The cached value of the '{@link #getPackagetype() <em>Packagetype</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPackagetype()
	 * @generated
	 * @ordered
	 */
	protected PackageKey packagetype = PACKAGETYPE_EDEFAULT;
	 ...
	 * @generated
	 */
	protected PackageAttributesImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OptimizationrulePackage.Literals.PACKAGE_ATTRIBUTES;
	}
	...
	public void setStartAttr(String newStartAttr) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptimizationrulePackage.PACKAGE_ATTRIBUTES__START_ATTR, oldStartAttr, startAttr));
	}
	...
	public void setEndAttr(String newEndAttr) {
		...
		endAttr = newEndAttr;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptimizationrulePackage.PACKAGE_ATTRIBUTES__END_ATTR, oldEndAttr, endAttr));
	}
	...
	public void setPackagetype(PackageKey newPackagetype) {
		...
		packagetype = newPackagetype == null ? PACKAGETYPE_EDEFAULT : newPackagetype;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptimizationrulePackage.PACKAGE_ATTRIBUTES__PACKAGETYPE, oldPackagetype, packagetype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OptimizationrulePackage.PACKAGE_ATTRIBUTES__START_ATTR:
				return getStartAttr();
			case OptimizationrulePackage.PACKAGE_ATTRIBUTES__END_ATTR:
				return getEndAttr();
			case OptimizationrulePackage.PACKAGE_ATTRIBUTES__PACKAGETYPE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case OptimizationrulePackage.PACKAGE_ATTRIBUTES__END_ATTR:
				...
				return;
			case OptimizationrulePackage.PACKAGE_ATTRIBUTES__PACKAGETYPE:
				setPackagetype(PACKAGETYPE_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case OptimizationrulePackage.PACKAGE_ATTRIBUTES__PACKAGETYPE:
				return packagetype != PACKAGETYPE_EDEFAULT;
		}
