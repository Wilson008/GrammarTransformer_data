 ...
 * </p>
 * <ul>
 *   <li>{@link org.bumble.xtext.grammaroptimizer.optimizationrule.impl.RemoveBracketImpl#getTargetAttribute <em>Target Attribute</em>}</li>
 *   <li>{@link org.bumble.xtext.grammaroptimizer.optimizationrule.impl.RemoveBracketImpl#getExcludedGrammarRule <em>Excluded Grammar Rule</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RemoveBracketImpl extends OptimizationRuleImpl implements RemoveBracket {
	/**
	...
	protected EClass eStaticClass() {
		return OptimizationrulePackage.Literals.REMOVE_BRACKET;
	}
	...
	public void setTargetAttribute(String newTargetAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptimizationrulePackage.REMOVE_BRACKET__TARGET_ATTRIBUTE, oldTargetAttribute, targetAttribute));
	}
	...
	public EList<String> getExcludedGrammarRule() {
		if (excludedGrammarRule == null) {
			excludedGrammarRule = new EDataTypeUniqueEList<String>(String.class, this, OptimizationrulePackage.REMOVE_BRACKET__EXCLUDED_GRAMMAR_RULE);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OptimizationrulePackage.REMOVE_BRACKET__TARGET_ATTRIBUTE:
				return getTargetAttribute();
			case OptimizationrulePackage.REMOVE_BRACKET__EXCLUDED_GRAMMAR_RULE:
