...
/**
 * This is the item provider adapter for a {@link dot.Subgraph} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubgraphItemProvider extends SubgraphOrEdgeStmtSubgraphItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subgraph_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subgraph_name_feature", "_UI_Subgraph_type"),
				 DotPackage.Literals.SUBGRAPH__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DotPackage.Literals.SUBGRAPH__STMTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Subgraph.class)) {
			case DotPackage.SUBGRAPH__NAME:
				...
				return;
			case DotPackage.SUBGRAPH__STMTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DotPackage.Literals.SUBGRAPH__STMTS,
