...
public class DotGraphTest extends TestCase {
	 ...
	 * @generated
	 */
	protected DotGraph fixture = null;
	...
	public static void main(String[] args) {
		TestRunner.run(DotGraphTest.class);
	}
	 ...
	 * @generated
	 */
	public DotGraphTest(String name) {
		super(name);
	}
	 ...
	 * @generated
	 */
	protected void setFixture(DotGraph fixture) {
	...
	protected void setUp() throws Exception {
		setFixture(DotFactory.eINSTANCE.createDotGraph());
	}
