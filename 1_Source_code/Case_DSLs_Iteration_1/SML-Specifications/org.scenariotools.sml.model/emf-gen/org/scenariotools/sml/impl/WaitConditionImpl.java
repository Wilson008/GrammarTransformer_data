...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Wait Condition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.scenariotools.sml.impl.WaitConditionImpl#isStrict <em>Strict</em>}</li>
 *   <li>{@link org.scenariotools.sml.impl.WaitConditionImpl#isRequested <em>Requested</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WaitConditionImpl extends ConditionFragmentImpl implements WaitCondition {
	/**
	...
	protected EClass eStaticClass() {
		return SmlPackage.Literals.WAIT_CONDITION;
	}
	...
	public void setStrict(boolean newStrict) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmlPackage.WAIT_CONDITION__STRICT, oldStrict, strict));
	}
	...
	public void setRequested(boolean newRequested) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmlPackage.WAIT_CONDITION__REQUESTED, oldRequested, requested));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SmlPackage.WAIT_CONDITION__STRICT:
				return isStrict();
			case SmlPackage.WAIT_CONDITION__REQUESTED:
				return isRequested();
		}
