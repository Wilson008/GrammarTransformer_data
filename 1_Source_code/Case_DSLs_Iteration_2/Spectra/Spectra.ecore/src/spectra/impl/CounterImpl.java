 ...
 * </p>
 * <ul>
 *   <li>{@link spectra.impl.CounterImpl#getName <em>Name</em>}</li>
 *   <li>{@link spectra.impl.CounterImpl#getRange <em>Range</em>}</li>
 *   <li>{@link spectra.impl.CounterImpl#getInitial <em>Initial</em>}</li>
 *   <li>{@link spectra.impl.CounterImpl#getResetPred <em>Reset Pred</em>}</li>
 *   <li>{@link spectra.impl.CounterImpl#getIncPred <em>Inc Pred</em>}</li>
 *   <li>{@link spectra.impl.CounterImpl#getDecPred <em>Dec Pred</em>}</li>
 *   <li>{@link spectra.impl.CounterImpl#getOverflowMethod <em>Overflow Method</em>}</li>
 *   <li>{@link spectra.impl.CounterImpl#getUnderflowMethod <em>Underflow Method</em>}</li>
 * </ul>
 *
 * @generated
 */
