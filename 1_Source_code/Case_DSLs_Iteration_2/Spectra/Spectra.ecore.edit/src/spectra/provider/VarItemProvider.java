...
/**
 * This is the item provider adapter for a {@link spectra.Var} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VarItemProvider extends DeclItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Var_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Var_kind_feature", "_UI_Var_type"),
				 SpectraPackage.Literals.VAR__KIND,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpectraPackage.Literals.VAR__VAR);
		}
	...
	public String getText(Object object) {
		VarOwner labelValue = ((Var)object).getKind();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpectraPackage.Literals.VAR__VAR,
