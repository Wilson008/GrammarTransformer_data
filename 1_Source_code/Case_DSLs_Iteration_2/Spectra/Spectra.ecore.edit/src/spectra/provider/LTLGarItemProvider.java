...
/**
 * This is the item provider adapter for a {@link spectra.LTLGar} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LTLGarItemProvider extends DeclItemProvider {
	/**
	 ...
	 * @generated
	 */
	public LTLGarItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LTLGar_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LTLGar_name_feature", "_UI_LTLGar_type"),
				 SpectraPackage.Literals.LTL_GAR__NAME,
				 true,
				 false,
				 false,
	...
	protected void addSafetyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LTLGar_safety_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LTLGar_safety_feature", "_UI_LTLGar_type"),
				 SpectraPackage.Literals.LTL_GAR__SAFETY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStateInvPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LTLGar_stateInv_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LTLGar_stateInv_feature", "_UI_LTLGar_type"),
				 SpectraPackage.Literals.LTL_GAR__STATE_INV,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addJusticePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LTLGar_justice_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LTLGar_justice_feature", "_UI_LTLGar_type"),
				 SpectraPackage.Literals.LTL_GAR__JUSTICE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpectraPackage.Literals.LTL_GAR__PARAMS);
			childrenFeatures.add(SpectraPackage.Literals.LTL_GAR__TEMPORAL_EXPR);
			childrenFeatures.add(SpectraPackage.Literals.LTL_GAR__TRIG);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LTLGar"));
	}
	...
	public String getText(Object object) {
		String label = ((LTLGar)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LTLGar_type") :
			getString("_UI_LTLGar_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LTLGar.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpectraPackage.Literals.LTL_GAR__PARAMS,
		...
		newChildDescriptors.add
			(createChildParameter
				(SpectraPackage.Literals.LTL_GAR__TRIG,
