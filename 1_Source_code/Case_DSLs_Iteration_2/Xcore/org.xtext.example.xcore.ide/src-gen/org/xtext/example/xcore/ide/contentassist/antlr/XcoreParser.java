 ...
 */
package org.xtext.example.xcore.ide.contentassist.antlr;
...
import org.xtext.example.xcore.ide.contentassist.antlr.internal.InternalXcoreParser;
...
public class XcoreParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, XcoreGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getXParameterAccess().getAlternatives_2(), "rule__XParameter__Alternatives_2");
			...
			builder.put(grammarAccess.getXAnnotationAccess().getGroup_3_2(), "rule__XAnnotation__Group_3_2__0");
			...
			builder.put(grammarAccess.getXAnnotationDirectiveAccess().getGroup_1(), "rule__XAnnotationDirective__Group_1__0");
			builder.put(grammarAccess.getXAnnotationDirectiveAccess().getGroup_1_0(), "rule__XAnnotationDirective__Group_1_0__0");
			...
			builder.put(grammarAccess.getXTypeParameterAccess().getGroup_3(), "rule__XTypeParameter__Group_3__0");
			builder.put(grammarAccess.getXTypeParameterAccess().getGroup_3_2(), "rule__XTypeParameter__Group_3_2__0");
			...
			builder.put(grammarAccess.getXDataTypeAccess().getGroup_4(), "rule__XDataType__Group_4__0");
			builder.put(grammarAccess.getXDataTypeAccess().getGroup_4_2(), "rule__XDataType__Group_4_2__0");
			builder.put(grammarAccess.getXDataTypeAccess().getGroup_7_0(), "rule__XDataType__Group_7_0__0");
			builder.put(grammarAccess.getXDataTypeAccess().getGroup_7_1(), "rule__XDataType__Group_7_1__0");
			builder.put(grammarAccess.getXEnumAccess().getGroup(), "rule__XEnum__Group__0");
			builder.put(grammarAccess.getXEnumAccess().getGroup_5(), "rule__XEnum__Group_5__0");
			builder.put(grammarAccess.getXEnumAccess().getGroup_5_1(), "rule__XEnum__Group_5_1__0");
			builder.put(grammarAccess.getXGenericTypeAccess().getGroup(), "rule__XGenericType__Group__0");
			builder.put(grammarAccess.getXGenericTypeAccess().getGroup_2(), "rule__XGenericType__Group_2__0");
			builder.put(grammarAccess.getXGenericTypeAccess().getGroup_2_2(), "rule__XGenericType__Group_2_2__0");
			...
			builder.put(grammarAccess.getXParameterAccess().getGroup_2_0(), "rule__XParameter__Group_2_0__0");
			builder.put(grammarAccess.getXParameterAccess().getGroup_2_1(), "rule__XParameter__Group_2_1__0");
			...
			builder.put(grammarAccess.getXEnumLiteralAccess().getGroup_4(), "rule__XEnumLiteral__Group_4__0");
			...
			builder.put(grammarAccess.getXAnnotationAccess().getSourceAssignment_2(), "rule__XAnnotation__SourceAssignment_2");
			builder.put(grammarAccess.getXAnnotationAccess().getDetailsAssignment_3_1(), "rule__XAnnotation__DetailsAssignment_3_1");
			builder.put(grammarAccess.getXAnnotationAccess().getDetailsAssignment_3_2_1(), "rule__XAnnotation__DetailsAssignment_3_2_1");
			...
			builder.put(grammarAccess.getXAnnotationDirectiveAccess().getSourceURIAssignment_1_0_1(), "rule__XAnnotationDirective__SourceURIAssignment_1_0_1");
			builder.put(grammarAccess.getXAnnotationDirectiveAccess().getNameAssignment_3(), "rule__XAnnotationDirective__NameAssignment_3");
			builder.put(grammarAccess.getXStringToStringMapEntryAccess().getKeyAssignment_1(), "rule__XStringToStringMapEntry__KeyAssignment_1");
			builder.put(grammarAccess.getXStringToStringMapEntryAccess().getValueAssignment_3(), "rule__XStringToStringMapEntry__ValueAssignment_3");
			builder.put(grammarAccess.getXTypeParameterAccess().getAnnotationsAssignment_1(), "rule__XTypeParameter__AnnotationsAssignment_1");
			builder.put(grammarAccess.getXTypeParameterAccess().getNameAssignment_2(), "rule__XTypeParameter__NameAssignment_2");
			builder.put(grammarAccess.getXTypeParameterAccess().getBoundsAssignment_3_1(), "rule__XTypeParameter__BoundsAssignment_3_1");
			builder.put(grammarAccess.getXTypeParameterAccess().getBoundsAssignment_3_2_1(), "rule__XTypeParameter__BoundsAssignment_3_2_1");
			...
			builder.put(grammarAccess.getXDataTypeAccess().getAnnotationsAssignment_1(), "rule__XDataType__AnnotationsAssignment_1");
			builder.put(grammarAccess.getXDataTypeAccess().getNameAssignment_3(), "rule__XDataType__NameAssignment_3");
			builder.put(grammarAccess.getXDataTypeAccess().getTypeParametersAssignment_4_1(), "rule__XDataType__TypeParametersAssignment_4_1");
			builder.put(grammarAccess.getXDataTypeAccess().getTypeParametersAssignment_4_2_1(), "rule__XDataType__TypeParametersAssignment_4_2_1");
			builder.put(grammarAccess.getXDataTypeAccess().getInstanceTypeAssignment_6(), "rule__XDataType__InstanceTypeAssignment_6");
			builder.put(grammarAccess.getXDataTypeAccess().getSerializableAssignment_7_0_0(), "rule__XDataType__SerializableAssignment_7_0_0");
			builder.put(grammarAccess.getXDataTypeAccess().getCreateBodyAssignment_7_0_1(), "rule__XDataType__CreateBodyAssignment_7_0_1");
			builder.put(grammarAccess.getXDataTypeAccess().getConvertBodyAssignment_7_1_1(), "rule__XDataType__ConvertBodyAssignment_7_1_1");
			builder.put(grammarAccess.getXEnumAccess().getAnnotationsAssignment_1(), "rule__XEnum__AnnotationsAssignment_1");
			builder.put(grammarAccess.getXEnumAccess().getNameAssignment_3(), "rule__XEnum__NameAssignment_3");
			builder.put(grammarAccess.getXEnumAccess().getLiteralsAssignment_5_0(), "rule__XEnum__LiteralsAssignment_5_0");
			builder.put(grammarAccess.getXEnumAccess().getLiteralsAssignment_5_1_1(), "rule__XEnum__LiteralsAssignment_5_1_1");
			builder.put(grammarAccess.getXGenericTypeAccess().getTypeAssignment_1(), "rule__XGenericType__TypeAssignment_1");
			builder.put(grammarAccess.getXGenericTypeAccess().getTypeArgumentsAssignment_2_1(), "rule__XGenericType__TypeArgumentsAssignment_2_1");
			builder.put(grammarAccess.getXGenericTypeAccess().getTypeArgumentsAssignment_2_2_1(), "rule__XGenericType__TypeArgumentsAssignment_2_2_1");
			...
			builder.put(grammarAccess.getXParameterAccess().getAnnotationsAssignment_1(), "rule__XParameter__AnnotationsAssignment_1");
			builder.put(grammarAccess.getXParameterAccess().getUnorderedAssignment_2_0_0(), "rule__XParameter__UnorderedAssignment_2_0_0");
			builder.put(grammarAccess.getXParameterAccess().getUniqueAssignment_2_0_1(), "rule__XParameter__UniqueAssignment_2_0_1");
			builder.put(grammarAccess.getXParameterAccess().getUniqueAssignment_2_1_0(), "rule__XParameter__UniqueAssignment_2_1_0");
			builder.put(grammarAccess.getXParameterAccess().getUnorderedAssignment_2_1_1(), "rule__XParameter__UnorderedAssignment_2_1_1");
			builder.put(grammarAccess.getXParameterAccess().getTypeAssignment_3(), "rule__XParameter__TypeAssignment_3");
			builder.put(grammarAccess.getXParameterAccess().getMultiplicityAssignment_4(), "rule__XParameter__MultiplicityAssignment_4");
			builder.put(grammarAccess.getXParameterAccess().getNameAssignment_5(), "rule__XParameter__NameAssignment_5");
			builder.put(grammarAccess.getXEnumLiteralAccess().getAnnotationsAssignment_1(), "rule__XEnumLiteral__AnnotationsAssignment_1");
			builder.put(grammarAccess.getXEnumLiteralAccess().getNameAssignment_2(), "rule__XEnumLiteral__NameAssignment_2");
			builder.put(grammarAccess.getXEnumLiteralAccess().getLiteralAssignment_3_1(), "rule__XEnumLiteral__LiteralAssignment_3_1");
			builder.put(grammarAccess.getXEnumLiteralAccess().getValueAssignment_4_1(), "rule__XEnumLiteral__ValueAssignment_4_1");
			...
			builder.put(grammarAccess.getXDataTypeAccess().getUnorderedGroup_7(), "rule__XDataType__UnorderedGroup_7");
