...
public class XcoreSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_XEnum_CommaKeyword_5_1_0_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_XEnum_CommaKeyword_5_1_0_q = new TokenAlias(false, true, grammarAccess.getXEnumAccess().getCommaKeyword_5_1_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_XEnum_CommaKeyword_5_1_0_q.equals(syntax))
				emit_XEnum_CommaKeyword_5_1_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_XEnum_CommaKeyword_5_1_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
