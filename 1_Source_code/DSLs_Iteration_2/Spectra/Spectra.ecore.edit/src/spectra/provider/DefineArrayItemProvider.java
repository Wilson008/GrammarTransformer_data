...
/**
 * This is the item provider adapter for a {@link spectra.DefineArray} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DefineArrayItemProvider 
	 ...
	 * @generated
	 */
	public DefineArrayItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpectraPackage.Literals.DEFINE_ARRAY__SIMPLE_EXPRS);
			childrenFeatures.add(SpectraPackage.Literals.DEFINE_ARRAY__INNER_ARRAYS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DefineArray"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_DefineArray_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DefineArray.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpectraPackage.Literals.DEFINE_ARRAY__SIMPLE_EXPRS,
		...
		newChildDescriptors.add
			(createChildParameter
				(SpectraPackage.Literals.DEFINE_ARRAY__INNER_ARRAYS,
