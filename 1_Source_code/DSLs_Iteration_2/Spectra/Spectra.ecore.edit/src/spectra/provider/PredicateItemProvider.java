...
/**
 * This is the item provider adapter for a {@link spectra.Predicate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PredicateItemProvider extends DeclItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Predicate_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Predicate_name_feature", "_UI_Predicate_type"),
				 SpectraPackage.Literals.PREDICATE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpectraPackage.Literals.PREDICATE__PARAMS);
			childrenFeatures.add(SpectraPackage.Literals.PREDICATE__BODY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpectraPackage.Literals.PREDICATE__PARAMS,
				 SpectraFactory.eINSTANCE.createTypedParamList()));

		newChildDescriptors.add
			(createChildParameter
				(SpectraPackage.Literals.PREDICATE__BODY,
