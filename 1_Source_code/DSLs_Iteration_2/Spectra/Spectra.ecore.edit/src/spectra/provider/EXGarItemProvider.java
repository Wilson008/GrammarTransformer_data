...
/**
 * This is the item provider adapter for a {@link spectra.EXGar} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EXGarItemProvider extends DeclItemProvider {
	/**
	 ...
	 * @generated
	 */
	public EXGarItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EXGar_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EXGar_name_feature", "_UI_EXGar_type"),
	...
	/**
	 * This adds a property descriptor for the Reg Exp Pointer feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRegExpPointerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EXGar_regExpPointer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EXGar_regExpPointer_feature", "_UI_EXGar_type"),
				 SpectraPackage.Literals.EX_GAR__REG_EXP_POINTER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpectraPackage.Literals.EX_GAR__ELEMENTS);
			childrenFeatures.add(SpectraPackage.Literals.EX_GAR__REG_EXP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EXGar"));
	}
	...
	public String getText(Object object) {
		String label = ((EXGar)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EXGar_type") :
			getString("_UI_EXGar_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EXGar.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpectraPackage.Literals.EX_GAR__REG_EXP,
