 ...
 * </p>
 * <ul>
 *   <li>{@link xcore.impl.XStructuralFeatureImpl#isReadonly <em>Readonly</em>}</li>
 *   <li>{@link xcore.impl.XStructuralFeatureImpl#isVolatile <em>Volatile</em>}</li>
 *   <li>{@link xcore.impl.XStructuralFeatureImpl#isTransient <em>Transient</em>}</li>
 *   <li>{@link xcore.impl.XStructuralFeatureImpl#isUnsettable <em>Unsettable</em>}</li>
 *   <li>{@link xcore.impl.XStructuralFeatureImpl#isDerived <em>Derived</em>}</li>
 *   <li>{@link xcore.impl.XStructuralFeatureImpl#getGetBody <em>Get Body</em>}</li>
 *   <li>{@link xcore.impl.XStructuralFeatureImpl#getSetBody <em>Set Body</em>}</li>
 *   <li>{@link xcore.impl.XStructuralFeatureImpl#getIsSetBody <em>Is Set Body</em>}</li>
 *   <li>{@link xcore.impl.XStructuralFeatureImpl#getUnsetBody <em>Unset Body</em>}</li>
 * </ul>
 *
 * @generated
 */
