 ...
 * </p>
 * <ul>
 *   <li>{@link xcore.impl.XReferenceImpl#isContainer <em>Container</em>}</li>
 *   <li>{@link xcore.impl.XReferenceImpl#isContainment <em>Containment</em>}</li>
 *   <li>{@link xcore.impl.XReferenceImpl#isResolveProxies <em>Resolve Proxies</em>}</li>
 *   <li>{@link xcore.impl.XReferenceImpl#isLocal <em>Local</em>}</li>
 *   <li>{@link xcore.impl.XReferenceImpl#getOpposite <em>Opposite</em>}</li>
 *   <li>{@link xcore.impl.XReferenceImpl#getKeys <em>Keys</em>}</li>
 * </ul>
 *
 * @generated
 */
