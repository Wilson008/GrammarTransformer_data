 ...
 * @generated
 */
public class NumberTest extends FieldTest {
	 ...
	 */
	@Override
	protected BIBTEX.Number getFixture() {
		return (BIBTEX.Number)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(BIBTEXFactory.eINSTANCE.createNumber());
	}
