 ...
 * </p>
 * <ul>
 *   <li>{@link BIBTEX.impl.LocatedElementImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link BIBTEX.impl.LocatedElementImpl#getCommentsBefore <em>Comments Before</em>}</li>
 *   <li>{@link BIBTEX.impl.LocatedElementImpl#getCommentsAfter <em>Comments After</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class LocatedElementImpl extends MinimalEObjectImpl.Container implements LocatedElement {
	...
	protected EClass eStaticClass() {
		return BIBTEXPackage.Literals.LOCATED_ELEMENT;
	}
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BIBTEXPackage.LOCATED_ELEMENT__LOCATION, oldLocation, location));
	}
	...
	public EList<String> getCommentsBefore() {
		if (commentsBefore == null) {
			commentsBefore = new EDataTypeEList<String>(String.class, this, BIBTEXPackage.LOCATED_ELEMENT__COMMENTS_BEFORE);
		}
	...
	public EList<String> getCommentsAfter() {
		if (commentsAfter == null) {
			commentsAfter = new EDataTypeEList<String>(String.class, this, BIBTEXPackage.LOCATED_ELEMENT__COMMENTS_AFTER);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BIBTEXPackage.LOCATED_ELEMENT__LOCATION:
				return getLocation();
			case BIBTEXPackage.LOCATED_ELEMENT__COMMENTS_BEFORE:
				return getCommentsBefore();
			case BIBTEXPackage.LOCATED_ELEMENT__COMMENTS_AFTER:
