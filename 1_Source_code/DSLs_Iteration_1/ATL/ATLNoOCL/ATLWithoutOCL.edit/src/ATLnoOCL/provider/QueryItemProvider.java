...
/**
 * This is the item provider adapter for a {@link ATLnoOCL.Query} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QueryItemProvider extends UnitItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ATLnoOCLPackage.Literals.QUERY__BODY);
			childrenFeatures.add(ATLnoOCLPackage.Literals.QUERY__HELPERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ATLnoOCLPackage.Literals.QUERY__BODY,
				 ATLnoOCLFactory.eINSTANCE.createOCLDummy()));

		newChildDescriptors.add
			(createChildParameter
				(ATLnoOCLPackage.Literals.QUERY__HELPERS,
