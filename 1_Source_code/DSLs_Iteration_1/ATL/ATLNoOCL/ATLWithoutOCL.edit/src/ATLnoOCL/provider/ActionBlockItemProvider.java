...
/**
 * This is the item provider adapter for a {@link ATLnoOCL.ActionBlock} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionBlockItemProvider extends LocatedElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ATLnoOCLPackage.Literals.ACTION_BLOCK__STATEMENTS);
		}
	...
	public String getText(Object object) {
		String label = ((ActionBlock)object).getLocation();
		return label == null || label.length() == 0 ?
			getString("_UI_ActionBlock_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ATLnoOCLPackage.Literals.ACTION_BLOCK__STATEMENTS,
