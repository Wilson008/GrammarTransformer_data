...
/**
 * This is the item provider adapter for a {@link ATLnoOCL.Root} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RootItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ATLnoOCLPackage.Literals.ROOT__UNIT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Root.class)) {
			case ATLnoOCLPackage.ROOT__UNIT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ATLnoOCLPackage.Literals.ROOT__UNIT,
				 ATLnoOCLFactory.eINSTANCE.createLibrary()));

		newChildDescriptors.add
			(createChildParameter
				(ATLnoOCLPackage.Literals.ROOT__UNIT,
				 ATLnoOCLFactory.eINSTANCE.createQuery()));

		newChildDescriptors.add
			(createChildParameter
				(ATLnoOCLPackage.Literals.ROOT__UNIT,
				 ATLnoOCLFactory.eINSTANCE.createModule()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return ATLnoOCLEditPlugin.INSTANCE;
	}
