 ...
 * </p>
 * <ul>
 *   <li>{@link ATLnoOCL.impl.LibraryImpl#getHelpers <em>Helpers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LibraryImpl extends UnitImpl implements Library {
	...
	protected EClass eStaticClass() {
		return ATLnoOCLPackage.Literals.LIBRARY;
	}
	...
	public EList<Helper> getHelpers() {
		if (helpers == null) {
			helpers = new EObjectContainmentWithInverseEList<Helper>(Helper.class, this, ATLnoOCLPackage.LIBRARY__HELPERS, ATLnoOCLPackage.HELPER__LIBRARY);
		}
		return helpers;
	}
