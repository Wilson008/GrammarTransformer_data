 ...
 * </p>
 * <ul>
 *   <li>{@link ATLnoOCL.impl.MatchedRuleImpl#getInPattern <em>In Pattern</em>}</li>
 *   <li>{@link ATLnoOCL.impl.MatchedRuleImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link ATLnoOCL.impl.MatchedRuleImpl#getSuperRule <em>Super Rule</em>}</li>
 *   <li>{@link ATLnoOCL.impl.MatchedRuleImpl#isIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link ATLnoOCL.impl.MatchedRuleImpl#isIsRefining <em>Is Refining</em>}</li>
 *   <li>{@link ATLnoOCL.impl.MatchedRuleImpl#isIsNoDefault <em>Is No Default</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MatchedRuleImpl extends RuleImpl implements MatchedRule {
	...
	protected EClass eStaticClass() {
		return ATLnoOCLPackage.Literals.MATCHED_RULE;
	}
	...
	public NotificationChain basicSetInPattern(InPattern newInPattern, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ATLnoOCLPackage.MATCHED_RULE__IN_PATTERN, oldInPattern, newInPattern);
	...
	public void setInPattern(InPattern newInPattern) {
		if (newInPattern != inPattern) {
			...
			if (inPattern != null)
				msgs = ((InternalEObject)inPattern).eInverseRemove(this, ATLnoOCLPackage.IN_PATTERN__RULE, InPattern.class, msgs);
			if (newInPattern != null)
				msgs = ((InternalEObject)newInPattern).eInverseAdd(this, ATLnoOCLPackage.IN_PATTERN__RULE, InPattern.class, msgs);
			msgs = basicSetInPattern(newInPattern, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ATLnoOCLPackage.MATCHED_RULE__IN_PATTERN, newInPattern, newInPattern));
	}
	...
	public EList<MatchedRule> getChildren() {
		if (children == null) {
			children = new EObjectWithInverseResolvingEList<MatchedRule>(MatchedRule.class, this, ATLnoOCLPackage.MATCHED_RULE__CHILDREN, ATLnoOCLPackage.MATCHED_RULE__SUPER_RULE);
		}
		return children;
	}
	...
	public MatchedRule getSuperRule() {
		if (superRule != null && superRule.eIsProxy()) {
			...
			if (superRule != oldSuperRule) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ATLnoOCLPackage.MATCHED_RULE__SUPER_RULE, oldSuperRule, superRule));
			}
		}
		return superRule;
	}
	...
	public NotificationChain basicSetSuperRule(MatchedRule newSuperRule, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ATLnoOCLPackage.MATCHED_RULE__SUPER_RULE, oldSuperRule, newSuperRule);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSuperRule(MatchedRule newSuperRule) {
		if (newSuperRule != superRule) {
			NotificationChain msgs = null;
			if (superRule != null)
				msgs = ((InternalEObject)superRule).eInverseRemove(this, ATLnoOCLPackage.MATCHED_RULE__CHILDREN, MatchedRule.class, msgs);
			if (newSuperRule != null)
				msgs = ((InternalEObject)newSuperRule).eInverseAdd(this, ATLnoOCLPackage.MATCHED_RULE__CHILDREN, MatchedRule.class, msgs);
			msgs = basicSetSuperRule(newSuperRule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ATLnoOCLPackage.MATCHED_RULE__SUPER_RULE, newSuperRule, newSuperRule));
	}
	...
	public void setIsAbstract(boolean newIsAbstract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ATLnoOCLPackage.MATCHED_RULE__IS_ABSTRACT, oldIsAbstract, isAbstract));
	}
	...
	public void setIsRefining(boolean newIsRefining) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ATLnoOCLPackage.MATCHED_RULE__IS_REFINING, oldIsRefining, isRefining));
	}
	...
	public void setIsNoDefault(boolean newIsNoDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ATLnoOCLPackage.MATCHED_RULE__IS_NO_DEFAULT, oldIsNoDefault, isNoDefault));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ATLnoOCLPackage.MATCHED_RULE__IN_PATTERN:
				if (inPattern != null)
					msgs = ((InternalEObject)inPattern).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ATLnoOCLPackage.MATCHED_RULE__IN_PATTERN, null, msgs);
				return basicSetInPattern((InPattern)otherEnd, msgs);
			case ATLnoOCLPackage.MATCHED_RULE__CHILDREN:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getChildren()).basicAdd(otherEnd, msgs);
			case ATLnoOCLPackage.MATCHED_RULE__SUPER_RULE:
				if (superRule != null)
					msgs = ((InternalEObject)superRule).eInverseRemove(this, ATLnoOCLPackage.MATCHED_RULE__CHILDREN, MatchedRule.class, msgs);
